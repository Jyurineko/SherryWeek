        ...
        >
          <header className="sticky top-4 z-50 w-full px-4 sm:px-6 lg:px-8">
            <div className="container mx-auto">
              <div className="bg-white dark:bg-card rounded-2xl shadow-sm border border-gray-100 dark:border-border px-6 h-16 flex items-center justify-between">
                <Link href="/" className="text-xl font-bold tracking-tight text-gray-900 dark:text-foreground">
                  Cyberlilith
                </Link>
          ...
          <footer className="px-4 sm:px-6 lg:px-8 py-8 mt-8">
            <div className="container mx-auto">
              <div className="bg-white dark:bg-card rounded-2xl shadow-sm border border-gray-100 dark:border-border px-8 py-6">
